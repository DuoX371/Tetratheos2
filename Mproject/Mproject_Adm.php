...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Mproject_Adm.php">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                while ($record = mysqli_fetch_assoc($findRequest)){
                  //var_dump($record);

                  echo '<a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="font-weight-bold">
                      <div>' . $record['messageContent'] .'</div>
                    </div>
                  </a>';
                }
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div class="font-weight-bold">
                    <div>Hi there! I am wondering if you can help me with a problem I've been having.</div>
              ...
              <a class="dropdown-item text-center small text-gray-500"><button type="submit" name="clearMessage" style="border:none;background:none;outline:none;">Clear all</button></a>
            </form>
            </div>
            </li>
